...
volatile uint8_t send_temperature_uart = 0;
...
void SPI_SlaveInit(void){/* Set MISO output, all others input */
    DDRB = (1<<PB3);
    /* Enable SPI */
    SPCR = (1<<SPE);
}
...
{   
    ...
    while (1)
    {
        ...
        UART_printChar(SPI_SlaveReceive());
/*
        ...
        switch (gl_char_uart_buffer[0])
        {
            ...
            case 's':
                ...
                break;
       SPI_SlaveReceive()     case 'o':
            SPI_SlaveReceive()    //Befehlsaufbau: commando argument
            ...
            case 'O':
                ...
                UART_printText("ich bin ein master");
